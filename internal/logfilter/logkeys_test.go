...
var plainKeys = map[string]string{
	...
	"iperf_direction":    "both, down, up or bidir",
	...
	"producer_version":   "the version a restored backup says wrote it: file data, kept only when it is short and shaped like a version (web.versionStamp), and quoted back to the operator in the same words",
